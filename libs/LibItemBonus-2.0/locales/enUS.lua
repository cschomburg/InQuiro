...
lib.patterns = {
	...
	PATTERNS_OTHER = {
		...
		{ pattern = "Brilliant Wizard Oil", effect = {"SPELLPOWER", "SPELLCRIT"}, value = {36, 1} },
		...
		{ pattern = "Soulfrost", effect = {"FROSTSPELLPOWER", "SHADOWSPELLPOWER"}, value = {54, 54} },
		{ pattern = "Sunfire", effect = {"ARCANESPELLPOWER", "FIRESPELLPOWER"}, value = {50, 50} },
